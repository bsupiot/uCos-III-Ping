...
#define  DHCPc_CFG_MAX_RX_TIMEOUT_MS                   10000    /* Maximum inactivity time (ms) on receive.             */

#define  DHCPc_CFG_PARAM_REQ_TBL_SIZE                      5    /* Configure requested parameter table size.            */

#define  DHCPc_CFG_MAX_NBR_IF          NET_IF_CFG_MAX_NBR_IF    /* Configure maximum number of interface (see Note #3). */
...
#define  DHCPc_CFG_LOCAL_LINK_MAX_RETRY                    20   /* Configure maximum number of retry to get a           */
                                                                /* link-local address.                                  */
...
#define  DHCPc_CFG_ARG_CHK_EXT_EN                DEF_ENABLED
                                                                ...
                                                                /* ... (see Note #2) :                                  */
#define  DHCPc_CFG_ARG_CHK_DBG_EN                DEF_ENABLED
                                                                /*   DEF_DISABLED     Argument check DISABLED           */
                                                                /*   DEF_ENABLED      Argument check ENABLED            */
