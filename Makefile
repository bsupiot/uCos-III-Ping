...
SRC+= $(addprefix $(PRINTF_DIR)/, $(shell cd $(PRINTF_DIR); ls | grep -e '\.c'))
SRC+= $(KAL)
SRC+= $(BSP_INT)
...
CFLAGS = -mcpu=cortex-a7 -W -Wall -ansi $(INC) -std=gnu99 -g -D CPU_MCIMX6G2CVK05
